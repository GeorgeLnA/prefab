      ...
      <div className="w-full px-4 sm:px-5">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 md:gap-6 justify-center">
            ...
            <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 xl:mt-10 text-black/70 text-[9px] sm:text-[10px] md:text-xs lg:text-sm xl:text-base font-normal px-1 sm:px-2 md:px-0">
