        ...
        <article>
          ...
          <section className='text-black grid place-content-center h-screen sticky top-0 rounded-tr-2xl rounded-tl-2xl overflow-hidden'>
            <div className="relative z-10 max-w-3xl mx-auto px-8 py-12 rounded-xl bg-white shadow-lg backdrop-blur-md">
              <h1 className="text-4xl md:text-5xl font-thin text-primary mb-6 text-center">Technology</h1>
              <h2 className="text-2xl md:text-3xl font-thin mb-4 text-primary text-center">Revolutionizing Prefab Construction</h2>
              ...
              <h3 className="text-xl md:text-2xl font-thin mb-2 text-primary text-center">Precision Manufacturing Process</h3>
          ...
          <section className='text-white h-screen w-full grid place-content-center sticky top-0'>
            <div className="relative z-10 max-w-3xl mx-auto px-8 py-12 rounded-xl bg-white text-black shadow-lg backdrop-blur-md">
              <h2 className="text-3xl md:text-4xl font-thin text-primary mb-6 text-center">Sustainable, High-Performance Materials</h2>
              ...
              <h2 className="text-3xl md:text-4xl font-thin text-primary mb-6 text-center">Benefits of Our Technology</h2>
              <ul className="list-disc list-inside mb-6 mx-auto max-w-xl">
