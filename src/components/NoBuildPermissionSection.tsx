          ...
          >
            ...
            <div className="p-2 sm:p-2.5 md:p-3 lg:p-3.5 xl:p-4 flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="text-black/70 text-xs sm:text-[10px] md:text-xs lg:text-sm xl:text-base mb-0.5 sm:mb-0.5 md:mb-1 font-body font-thin">{house.subtext}</div>
                <div className="text-black/60 text-xs sm:text-[10px] md:text-xs lg:text-sm xl:text-base mb-0.5 sm:mb-1 line-clamp-2 font-body font-normal leading-relaxed">{house.explanation}</div>
              </div>
            </div>
          </Link>
        );
