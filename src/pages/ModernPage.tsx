  ...
  return (
    <>
      <SEO
        ...
        description="Sleek modern design with cutting-edge features. Premium materials and sophisticated aesthetics for contemporary living. Starting from £315,000."
        url="/modern"
      />
      <div>
        {/* Hero Section */}
      ...
      <section id="models" className="py-20 bg-white">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="text-primary text-sm uppercase tracking-wider mb-4 font-body font-medium">MODERN MODELS</div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-4 sm:mb-6">Contemporary Designs</h2>
