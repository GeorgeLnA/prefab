      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-primary text-sm uppercase tracking-wider mb-4">BUNGALOW EXCELLENCE</div>
            ...
            <p className="text-xl font-body font-normal text-gray-600 max-w-3xl mx-auto">
              Our Bungalow collection offers spacious single-storey living with open plan designs 
              and accessibility features for comfortable family life.
            </p>
          </div>
      ...
      <section id="models" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold text-white mb-6">Spacious Designs</h2>
            <p className="text-xl font-body font-normal text-gray-400 max-w-3xl mx-auto">
