      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold text-gray-800 mb-6">The Future is Now</h2>
      ...
      <section id="models" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold text-white mb-6">Intelligent Designs</h2>
                ...
                <div key={index} className="group cursor-pointer">
                  <div className="relative overflow-hidden bg-gray-800 transition-all duration-500 hover:bg-gray-750 rounded-lg">
                    ...
                    <div className="p-8">
                      ...
                      {house.description && (
                        <p className="text-gray-400 text-sm font-body font-normal leading-relaxed mb-4">
                          {house.description}
                        </p>
                      )}
