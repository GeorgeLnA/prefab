      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-primary text-sm uppercase tracking-wider mb-4">MOBILE EXCELLENCE</div>
            <h2 className="text-4xl font-light text-gray-800 mb-6">Flexible Living</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our Mobile collection offers the perfect solution for those who value flexibility 
              and freedom, without compromising on comfort and modern amenities.
            </p>
          </div>
      ...
      <section id="models" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-light text-white mb-6">Flexible Designs</h2>
